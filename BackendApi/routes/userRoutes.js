...
const {getAllIndiaSiIndicesOrInflationData, getAllIndiaItemIndicesOrInflationCombined,getMonths,getSector,getState,getItems,getGroups,getSubgroups} = cpiController

const iipController = require('../controllers/iipController')
const { getMonth, getFrequency,getCategory,getSubcategory,getIIPAnnual,getIIPMonthly} = iipController
...
const {getIndicators,getApproach,getRevision,getAccount,getFreq,getQuarterly,getInstitutional,getIndustry,getSubindustry,getNASData} = nasController

const {verifyJWT}=require("../auth/user.auth.middleware.js")
const adminController=require("../controllers/adminController.js")
const {signInAdmin,createProduct,createTheme,createMetadata,getProuduct,getMetaData,getTheme,updateProduct,updateTheme,updatedMetadata,deleteProduct,deleteMetadata,deleteTheme}=adminController;
