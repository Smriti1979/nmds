...
router.route("/product/:productId").get(verifyJWT, getProuduct);
...
router.route("/theme/:category").get(verifyJWT, getTheme);
...
router.route("/metadata/:Product").get(verifyJWT, getMetaData);
